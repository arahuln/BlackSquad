...
import Logo from "../assets/IsmMedia.png";
...
const SignUpNew = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    if (e.target.value.includes("iitism.ac.in")) {
      setIsModerator(true);
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isConsentGiven) {
      ...
      await dispatch(
        signUpAction(formData, navigate, isConsentGiven, email)
      );
      setLoading(false);
    ...
    <section className="bg-white">
      <div className="container mx-auto flex min-h-screen items-center justify-center px-6">
        <form className="w-full max-w-md" onSubmit={handleSubmit}>
          ...
          <label
            htmlFor="avatar"
            className="mt-6 flex cursor-pointer items-center rounded-lg border-2 border-dashed bg-white px-3 py-3 text-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <ContextAuthModal
              ...
              setIsConsentGiven={handleConsentGiven}
